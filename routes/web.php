...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('/user-profile', UserProfileController::class)->only(['store', 'show', 'update']);
    Route::post('/project/{id}/rate', [FeedbackController::class, 'store'])->name('project.rate');
    Route::put('/project/{project}/rate', [FeedbackController::class, 'update'])->name('project.rate.update');
    Route::post('/project/{id}/favorite', [FavoriteController::class, 'store'])->name('project.favorite');
