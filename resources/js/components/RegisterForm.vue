	...
	<div :class="cn('flex flex-col gap-6', props.class)">
		...
		<Card>
			<CardHeader class="text-center">
				<CardTitle class="text-xl"> Seja bem vindo! </CardTitle>
				<CardDescription>
					Cadastre-se com sua conta Github ou Google
				</CardDescription>
			</CardHeader>
			<CardContent>
				...
				<form @submit.prevent="submit">
					<div class="grid gap-6">
						...
						<div class="text-center text-sm">
							Já possui uma conta?
							<Link :href="route('login')" class="underline underline-offset-4 "> Entrar </Link>
						</div>
					</div>
				</form>
			</CardContent>
